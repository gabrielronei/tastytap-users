...
public class User {
    ...
    public boolean equals(Object o) {
        ...
        User user = (User) o;
        return Objects.equals(name, user.name) && Objects.equals(email, user.email) && Objects.equals(cpf, user.cpf) && Objects.equals(createdAt, user.createdAt) && role == user.role;
    }
